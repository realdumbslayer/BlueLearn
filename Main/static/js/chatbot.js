function sendMessage() {
    ...
    userMessage.innerHTML = "<img src='/static/images/ulogo.png' alt='Logo' class='ulogo'>You<br>" + userInput;
    ...
    .then(data => {
        var responseText = data.split('answer: ')[1].trim();
        var index = 0;
        var interval = setInterval(function() {
            var partialResponse = responseText.slice(0, index);
            ...
            if (index > responseText.length) {
                ...
                botMessage.innerHTML = "<img src='/static/images/chatbotlogo.jpg' alt='Logo' class='logo'>Chatbot<br>" + responseText; // Add logo before the message
